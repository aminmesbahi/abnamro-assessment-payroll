...
namespace UnitTests
{
    public static class PayrollContextSeed
    {
        public static async Task SeedAsync(PayrollContext payrollContext)
        {
            payrollContext.Database.EnsureDeleted();
        ...
        public static decimal CalculateTax(decimal grossIncome, List<TaxBracket> reference)
        {
