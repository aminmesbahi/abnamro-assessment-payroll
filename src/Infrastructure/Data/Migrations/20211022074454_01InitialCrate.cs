...
{
    public partial class _01InitialCrate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PaymentFactor", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PaymentFactor_PaymentHistories_PaymentHistoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentFactor_PaymentHistoryId",
                table: "PaymentFactor",
